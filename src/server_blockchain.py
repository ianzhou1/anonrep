...
class BlockchainServer(Server):
    def __init__(self, host, port):
        ...
        new_msg_types = {
            Constants.NEW_MESSAGE: [str, int, list, list, list]
        }
    ...
    def new_message(self, msg_args):
        client_msg, client_stp, client_sig, addresses, signatures = msg_args
        ...
        send(config.COORDINATOR_ADDR, [Constants.POST_MESSAGE, client_msg, client_stp, addresses])
