...
def sign(account, msg):
	return account.signHash(defunct_hash_message(bytes(msg, encoding='utf-8')))

def verify(addr, msg, signature):
	return Account.recoverHash(defunct_hash_message(bytes(msg, encoding='utf-8')), signature=signature) == addr
